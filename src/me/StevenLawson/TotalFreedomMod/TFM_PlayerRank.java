...
public enum TFM_PlayerRank
{
    ...
    MODERATOR("The " + ChatColor.RED + "Console", ChatColor.DARK_RED + "[Moderator]"),
    SYS("The " + ChatColor.DARK_RED + "Console", ChatColor.DARK_RED + "[Sys-Admin]"),
    LEADDEV("The " + ChatColor.DARK_PURPLE + "Console", ChatColor.DARK_PURPLE + "[Lead Dev]");
    ...
    public static TFM_PlayerRank fromSender(CommandSender sender)
    {
        ...
        if (entry != null && entry.isActivated())
        {
            ...
            else if (TFM_ConfigEntry.SERVER_MODERATORS.getList().contains(sender.getName()))
            {
                return MODERATOR;
            }
